<div align="center">
    <img src="https://raw.githubusercontent.com/u-wz/helm/main/public/Helm.svg" width="200" height="200" alt="Helm Logo" />
  <p style="margin: 0; margin-top: 0.5rem;">
    <strong>The North Star for Egyptian Computer Science Students</strong>
  </p>
  <p style="margin: 0; margin-top: 0.5rem; color: #666;">
  ...
  <div style="margin-top: 1.5rem; display: flex; gap: 0.75rem; flex-wrap: wrap; justify-content: center;">
    <a href="#-features" style="color: #4361EE; text-decoration: none; font-weight: 600;">Features</a>
    <span style="color: #ccc;">•</span>
    <a href="#-tech-stack" style="color: #4361EE; text-decoration: none; font-weight: 600;">Tech Stack</a>
    <span style="color: #ccc;">•</span>
    <a href="#-getting-started" style="color: #4361EE; text-decoration: none; font-weight: 600;">Getting Started</a>
    <span style="color: #ccc;">•</span>
    <a href="#-project-structure" style="color: #4361EE; text-decoration: none; font-weight: 600;">Project Structure</a>
    <span style="color: #ccc;">•</span>
    <a href="#-design-system" style="color: #4361EE; text-decoration: none; font-weight: 600;">Design System</a>
  </div>
</div>
...
**What Helm is:**
- ✅ A free, open-source reference site for Egyptian CS students
- ✅ Curated learning roadmaps for different tracks
- ✅ Gold-standard courses from top platforms (Harvard, Stanford, etc.)
- ✅ Career guidance specifically for the Egyptian market
- ✅ Essential developer tools and free student benefits
- ✅ CV & project templates for real-world use
...
Each track includes:
- ✅ Phased learning steps with estimated days per step
- ✅ Resource links (courses, tutorials, documentation)
- ✅ Build projects to complete each phase
- ✅ Egyptian market context and FAQs
...
**Course Features:**
- ✅ Star ratings (curated by Egyptian CS students)
- ✅ Filter by track, level, format, language
- ✅ Certificate availability
- ✅ Arabic content support
- ✅ Financial aid helper (Coursera/edX)
...
- **[CONTRIBUTING.md](./CONTRIBUTING.md)** — How to add content, code style, and contribute
- **[specs.md](./specs.md)** — Deep technical documentation of all features
...
│   ├── page.tsx                  # Home page (hero, quick stats, year filter, site overview, FAQ, reviews)
│   ├── layout.tsx                # Root layout (metadata, providers, navbar, footer)
│   ├── globals.css               # Global styles, design tokens, animations
│   ├── careers/
│   │   └── page.tsx              # Careers page (hiring process, companies, job boards, remote guide, internships, FAQ)
│   ├── courses/
│   │   └── page.tsx              # Courses page (search, filters, course cards, financial aid helper, FAQ)
│   ├── cv-projects/
│   │   └── page.tsx              # CV & projects page (CV guide, templates, graduation project guide, project ideas, FAQ)
│   ├── roadmaps/
│   │   └── page.tsx              # Roadmaps page (track selector, phase accordions, progress tracking, FAQs)
│   └── tools/
│       └── page.tsx              # Tools page (category filters, tool cards, ITI highlight, VS Code extensions, FAQ)
├── components/
│   ├── home/                     # Home page components
│   │   ├── Hero.tsx              # Hero section with CTAs
│   │   ├── QuickStats.tsx        # Statistics (courses, tools, reviews, etc.)
│   │   ├── YearFilter.tsx        # Filter reviews by year
│   │   ├── SiteOverview.tsx      # Overview of all sections
│   │   └── Reviewssection.tsx    # Student reviews carousel
│   ├── feedback/                 # Feedback system
│   │   ├── FeedbackForm.tsx      # Inline feedback form
│   │   └── FeedbackModal.tsx     # Modal feedback form
│   ├── layout/                   # Layout components
│   │   ├── Navbar.tsx            # Navigation bar
│   │   ├── Footer.tsx            # Footer with links and social
│   │   └── ThemeProvider.tsx     # Dark/light theme provider
│   ├── ui/                       # Reusable UI components
│   │   ├── NeoCard.tsx           # Neo-brutalist card
│   │   ├── NeoButton.tsx         # Neo-brutalist button
│   │   ├── NeoInput.tsx          # Neo-brutalist input
│   │   ├── NeoAccordion.tsx      # Neo-brutalist accordion
│   │   ├── NeoBadge.tsx          # Neo-brutalist badge
│   │   ├── NeoDialog.tsx         # Neo-brutalist dialog
│   │   ├── NeoToast.tsx          # Neo-brutalist toast notifications
│   │   ├── NeoStar.tsx           # Neo-brutalist decorative stars
│   │   ├── ProgressBar.tsx       # Progress bar component
│   │   └── SplitText.tsx         # Split text animation
│   └── home/
│       └── FeelingLostModal.tsx  # Modal for users feeling lost
├── data/                         # Data files
│   ├── courses.ts                # 200+ courses (1643 lines)
│   ├── tools.ts                  # 100+ tools (2055 lines)
│   ├── roadmaps.ts               # 8 roadmaps (1539 lines)
│   ├── projects.ts               # 100+ project ideas (364 lines)
│   ├── companies.ts              # 30+ Egyptian tech companies
│   ├── jobBoards.ts              # Job board listings
│   ├── faqs.ts                   # FAQ items (209 lines)
│   └── reviews.ts                # Student reviews (5 reviews)
├── hooks/                        # Custom React hooks
│   ├── useProgress.ts            # Progress tracking (roadmaps)
│   ├── useCopyLink.ts            # Copy to clipboard utility
│   ├── useScrollReveal.ts        # Scroll reveal animations
│   └── useLocalStorage.ts        # Local storage utility
├── lib/                          # Utility libraries
│   ├── utils.ts                  # Helper functions (cn utility)
│   └── constants.ts              # App constants (badges, page accents, etc.)
...
- **[CONTRIBUTING.md](./CONTRIBUTING.md)** — How to add content, code style, and contribute
- **[specs.md](./specs.md)** — Deep technical documentation of all features
- **[neobrutalism.dev](https://neobrutalism.dev)** — Official NeoBrutalist design system reference
...
**Medium Priority:**
1. 📖 More detailed FAQs (by track, by company)
...
<div align="center">
  ...
  <p>Contribute to make it better: <a href="https://github.com/u-wz/helm" style="color: #4361EE;">github.com/u-wz/helm</a></p>
</div>
